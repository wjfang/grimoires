/**
 * Find_interfaceByOperationMetadata.java
 *
...
public class Find_interfaceByOperationMetadata  extends AbstractMessage  implements java.io.Serializable , InquireWsdlMetadataMessage, InquireWsdlMetadataProcessable {
    private uk.ac.soton.ecs.grimoires.server.impl.metadata.datamodel.MetadataQueryBag metadataQueryBag;

    public Find_interfaceByOperationMetadata() {
    }
    ...
    /**
     * Gets the metadataQueryBag value for this Find_interfaceByOperationMetadata.
     * 
    ...
    /**
     * Sets the metadataQueryBag value for this Find_interfaceByOperationMetadata.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Find_interfaceByOperationMetadata)) return false;
        Find_interfaceByOperationMetadata other = (Find_interfaceByOperationMetadata) obj;
