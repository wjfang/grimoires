...
public class BusinessDetailExt  implements java.io.Serializable , uk.ac.soton.ecs.grimoires.server.impl.uddiv2.handlers.UDDIv2DataModelVisitable {
    private uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt[] businessEntityExt;
    ...
    public BusinessDetailExt(
           uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt[] businessEntityExt,
     ...
     */
    public uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt[] getBusinessEntityExt() {
        return businessEntityExt;
    }
     ...
     */
    public void setBusinessEntityExt(uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt[] businessEntityExt) {
        this.businessEntityExt = businessEntityExt;
    }

    public uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt getBusinessEntityExt(int i) {
        return this.businessEntityExt[i];
    }

    public void setBusinessEntityExt(int i, uk.ac.soton.ecs.grimoires.server.impl.uddiv2.datamodel.BusinessEntityExt _value) {
