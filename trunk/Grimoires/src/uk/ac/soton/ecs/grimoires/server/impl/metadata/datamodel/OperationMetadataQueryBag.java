/**
 * OperationMetadataQueryBag.java
 *
...
public class OperationMetadataQueryBag  implements java.io.Serializable , MetadataModelVisitable {
    private uk.ac.soton.ecs.grimoires.server.impl.metadata.datamodel.MetadataQuery[] metadataQuery;

    public OperationMetadataQueryBag() {
    }
    ...
    /**
     * Gets the metadataQuery value for this OperationMetadataQueryBag.
     * 
    ...
    /**
     * Sets the metadataQuery value for this OperationMetadataQueryBag.
     * 
     * @param metadataQuery
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof OperationMetadataQueryBag)) return false;
        OperationMetadataQueryBag other = (OperationMetadataQueryBag) obj;
 ...
 /** Grimoires specific methods and constructors */ 
  ...
  public Object accept (MetadataModelVisitor v) { return v.process(this); }
    ...
    public OperationMetadataQueryBag (Model m, Resource r) throws RDFException, StoreException {       throw new UnsupportedOperationException ("No implementation for constructor taking (Model, Resource) in OperationMetadataQueryBag");       }
