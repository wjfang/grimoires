...
public class MetadataQueryBag  implements java.io.Serializable , MetadataModelVisitable {
    private uk.ac.soton.ecs.grimoires.server.impl.metadata.datamodel.MetadataQuery[] metadataQuery;

    public MetadataQueryBag() {
    }
    ...
    /**
     * Gets the metadataQuery value for this MetadataQueryBag.
     * 
    ...
    /**
     * Sets the metadataQuery value for this MetadataQueryBag.
     * 
     * @param metadataQuery
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof MetadataQueryBag)) return false;
        MetadataQueryBag other = (MetadataQueryBag) obj;
 ...
 /** Grimoires specific methods and constructors */ 
  ...
  public Object accept (MetadataModelVisitor v) { return v.process(this); }
    ...
    public MetadataQueryBag (Model m, Resource r) throws RDFException, StoreException {       throw new UnsupportedOperationException ("No implementation for constructor taking (Model, Resource) in MetadataQueryBag");       }
